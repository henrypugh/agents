...
class Conversation:
    ...
    # Remaining methods would be similar to original but adapted for the responses API
    # These methods would need to be updated to handle the new response structure
    # For brevity, I'm not showing all of them
